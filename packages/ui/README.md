...
Shared UI components for the BookMe platform, built with React, TypeScript, and Tailwind CSS.
...
All components use Tailwind CSS and are designed to match the Hong Kong business aesthetic with a professional color palette.
